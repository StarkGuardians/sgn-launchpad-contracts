...
from Libraries.MerkleVerifier import MerkleVerifier
from openzeppelin.token.erc721.enumerable.library import ERC721Enumerable
from sgn_launchpad.contract_metadata import ERC721_Contract_Metadata
...
@storage_var
func contract_uri_data(id : felt) -> (res: felt) {
}
...
func isWhitelisted{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
    ...
    let isVerified : felt = MerkleVerifier.verify(leaf, _merkle_root, user_proof_len, user_proof);
